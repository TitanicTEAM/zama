...
تم كتابه وبرمجة السورس بوسطه المطور
 شهاب الرشيد THE SOURCE BY : @shahab0fbi
...
var = false
send(msg.chat_id_,msg.id_, 1, "🍁» اهلا عزيزي عليك الاشتراك اولا ل \n⭕️» استخدام البوت: ["..channel.."]🍃\n", 1 , "md")
elseif data.ok then
return var
end
else
...
send(msg.chat_id_, msg.id_, 1, "👨🏾‍🌾┊ اهلا عزيزي تم حفظ الرد بنجاح\n", 1, 'md')
...
send(msg.chat_id_, msg.id_, 1, "👨🏿‍🎓↓ عزيزي حدث خطا حاول مره اخرى", 1, "md")
...
send(msg.chat_id_, msg.id_, 1, "👨🏿‍🎓┊ اهلا عزيزي تم الغاء الامر بنجاح ✓ ", 1, "md")
...
send(msg.chat_id_, msg.id_, 1, "✍🏾┊ اهلا عزيزي تم وضع اسم البوت ✓",1, 'html')
return false
end
------------------------save cam link-----------------------------------
...
send(msg.chat_id_, msg.id_, 1, "👮🏻┊  اهلا عزيزي تم حفظ القوانين👨🏾‍🌾",  1, "md")
...
send(msg.chat_id_, msg.id_, 1, "👨🏾‍🌾┊ تم وضع معرف القناه ❗️\n👨🏾‍🌾┊ ارفع البوت ادمن في قناتك\n",1, 'html')
end end
---------------------rem cam broadcast--------------------------------------------------------------------
if redis:get(KEEPER.."broadcast" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then
...
send(msg.chat_id_, msg.id_, 1, "👨🏻‍💻┊ اهلا عزيزي المطور👨🏾‍🌾تم وضع الكليشه بنجاح", 1, "md")
end
--------------------check_filter_words---------------------------------------------------------
if not is_vipmem(msg.sender_user_id_, msg.chat_id_) then
...
-------------------------------leave groups----------------------------------------------------------------------
if is_sudo(msg) and idf:match("-100(%d+)") and (text:match('^'..(redis:get(KEEPER..'keepernams') or 'دعبول')..' غادر$')) then
send(msg.chat_id_, msg.id_, 1, "✺↓ اوكي حظره المطور سوف اغادر ..باي گایر😓",  1, "md")
redis:srem(KEEPER.."bot:groups", msg.chat_id_)
chat_leave(msg.chat_id_, bot_id)
end
--------------------------------------------
...
💠┊مرحبا انا بوت اسمي *(]]..(redis:get(KEEPER..'keepernams') or 'دعبول')..[[)🗼*
...
send(msg.chat_id_, msg.id_, 1, "👨🏾‍🌾┊ حسننا عزيزي المطور الان ارسل لي الكليشه🚶🏻", 1, "md")
...
local botnamess = redis:get(KEEPER.."keepernams") or "دعبول"
...
------------------SOURCE KEEPER---------------------------------------------------
if text:match("^4654$") or text:match("^654654$") or text:match("^54665$") or  text:match("^654654$") or text:match("^6546$") then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local text =  [[
‏
‏
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {'اي نعم اني '..(redis:get(KEEPER..'keepernams') or 'دعبول')..' 🍃😐','اهو اجوي الملطلطين 😹😪','بشحمه ولحمه شتريد بلا 😹😪','ها اروح لل🚽 هسه اجي😣🏃🏃','وياك اثول 😹😪','لصيحني مالي خلك😤من هسه اكلك/ج اي احبك/ج بعد لتصيحيني ابو/ام اللبن 😊','ها حبي شوف شوف عضلاتي 💪','تف 💦😙 عليك','لتصيحني نايم بلخاص 🌝✋🏿','د اشرب جايي تعال غير وكت😒😹','كافي تره كرهت اسمي 💔😠'}
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-------------------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"دووم الضحكه 🙊🍃","دوم الضحكه ℡̮⇣┆👑😻⇣ۦ " }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
